...
try:
    from ..abstractions.metrics import MetricsCollector, NoOpMetricsCollector
...
class TestNoOpMetricsCollector:
    ...
    def test_noop_endpoint_handler_returns_callable(self):
...
class TestPrometheusMetricsCollector:
    ...
    def test_prometheus_enabled_when_configured(self, enabled_config):
    ...
    def test_prometheus_walker_metrics_disabled_by_default(self):
    ...
    def test_prometheus_record_request_does_not_raise(self, enabled_config):
    ...
    def test_prometheus_active_requests_tracking(self, enabled_config):
    ...
    def test_prometheus_walker_recording(self, enabled_config):
    ...
    def test_prometheus_endpoint_handler_returns_response(self, enabled_config):
...
class TestUtilityFactoryMetrics:
    ...
    def test_factory_returns_noop_for_none_type(self):
